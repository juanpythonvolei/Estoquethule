              ...
              if uploaded_files:
                        ...
                        for nota in uploaded_files:
                                          try:  
                                              ...
                                              dict_pedido = {'cliente':cliente,'produtos':f'{codigo_produto} - {valor_produto}','descrição do produto':descricao_produto
                                                            ,'quantidade':quantidade_produto},'numero da nota':numero_da_nota,'processo':processo
