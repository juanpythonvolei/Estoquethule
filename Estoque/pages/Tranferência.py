...
with col1:
  deposito_origem = st.selectbox(index=None,label='',placeholder='Selecione o depósito de origem',options=['Rev','Dev','Rec','Ele'])
with col2:
  deposito_final= st.selectbox(index=None,label='',placeholder='Selecione o depósito de origem',options=['Rev'])
